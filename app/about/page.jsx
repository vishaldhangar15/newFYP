...
function About() {
  return (
    <div>
      <NavBar />
      <div className="mt-16">
        <div className="about border-4   min-h-screen bg-grey/[0.96] antialiased bg-grid-white/[0.2] text-foreground">
          <div className="container  p-20 py-4 mt-0">
            ...
            <p className="mb-8 text-white-400 md:text-lg text-center">
              ...
              comfortable living environment is crucial for student success, and
              we strive to provide top-notch facilities and services that cater
            ...
            <p className="mb-8 text-white-400 md:text-lg text-center">
              ...
              process of booking accommodations, applying for mess services, and
              managing your hostel ID card. With our user-friendly platform, you
              can easily:
            </p>
            <ul className="list-disc pl-6 mb-6 text-white-400 md:text-lg mx-auto max-w-3xl">
              ...
              <li className="mb-2">
                Obtain your personal hostel ID card for seamless entry and exit
              </li>
              <li className="mb-2">
            ...
            <p className="mb-8 text-white-400 md:text-lg text-center">
              ...
              who are committed to providing exceptional service and addressing
            ...
            <p className="text-foreground md:text-lg text-center">
              ...
              comfort, and camaraderie that VJTI Hostel has to offer. Contact us
              to learn more about our hostel and the application process.
            </p>
          </div>
        </div>
      </div>
